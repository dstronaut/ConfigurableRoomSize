...
class Patch_FindRoomForPosition
{
  ...
  private static Room CustomFindRoomForPosition(RoomRegistry self, BlockPos pos, ChunkRooms otherRooms)
  {
    ...
    var bf_blockAccess = Traverse.Create(self).Field("blockAccess");
    var blockAccess = (ICachingBlockAccessor)bf_blockAccess.GetValue();
    ...
    //int iteration = ++this.iteration; // EDITED: use travesed value
